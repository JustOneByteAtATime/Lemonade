    ...
    private fun clickLemonImage() {
        ...
        when (lemonadeState){
            ...
            SQUEEZE ->
            {
                ...
                {
                    DRINK
                    //  - Additionally, lemonSize is no longer relevant and should be set to -1 (address in DRINK)
                } else SQUEEZE
            }
        ...
        // Before the function terminates we need to set the view elements so that the
